...
class MecuGraph {
    ...
    add(data) {
        ...
        let [nodes, edges] = getGraphDataFromExtractedProteins(extrapolatedProteins, this.options.distanceMetric);
    ...
    render(){
        ...
        this.graph = cytoscape({
            ...
            layout: {
                ...
                fit: false,
                infinite: true,
                edgeLength: function(e){ return e.data('weight')*100; }
            }
        });
    }
    ...
    setEdgeLength(length = 100){
        this.graph.layout({
            ...
            fit: false,
            infinite: true,
            edgeLength: function(e){ return e.data('weight')*length; }
        });
    }
}
