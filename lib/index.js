...
class MecuGraph {
    ...
    add(data){
        ...
        let [nodes, edges] = getGraphDataFromExtractedProteins(realNewOnes, this.options.distanceMetric);
    ...
    remove(data){
        ...
        this.data = this.data.filter(function(element){
            return extrapolatedProteins.filter(function(exProt) {
                return exProt.p != element.p && exProt.e != element.e;
            });
        });
